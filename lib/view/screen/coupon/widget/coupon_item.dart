...
import 'package:com.makzan.eco/data/model/response/coupon_item_model.dart';
                    ...
                    Expanded(flex: 4,
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Text(coupons.seller != null? coupons.seller?.shop?.name??'' : AppConstants.appName,
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                         DottedBorder(
                          ...
                          Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                            child: Text('${getTranslated('valid_till', context)} ${DateConverter.dateTimeStringToDateTime(coupons.expireDate!)}',
