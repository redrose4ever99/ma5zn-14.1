...
import 'package:com.makzan.eco/data/model/response/cart_model.dart';
...
import 'package:com.makzan.eco/view/basewidget/animated_custom_dialog.dart';
...
import 'package:com.makzan.eco/view/basewidget/order_place_success_dialog.dart';
...
import 'package:com.makzan.eco/view/screen/checkout/widget/choose_payment_section.dart';
import 'package:com.makzan.eco/view/screen/checkout/widget/coupon_apply_widget.dart';
import 'package:com.makzan.eco/view/screen/checkout/widget/shipping_details_widget.dart';
import 'package:com.makzan.eco/view/screen/checkout/widget/wallet_payment.dart';
import 'package:com.makzan.eco/view/screen/dashboard/dashboard_screen.dart';
import 'package:com.makzan.eco/view/screen/offline_payment/offline_payment.dart';
                  ...
                  onTap: () async {
                    if (orderProvider.addressIndex == null &&
                      ...
                      for (int index = 0;
                          ...
                          index++) {
                        for (int i = 0;
                            i < cartProvider.chosenShippingList.length;
                            i++) {
                          if (cartProvider.chosenShippingList[i].cartGroupId ==
                              widget.cartList[index].cartGroupId) {
                            cartList[index].shippingMethodId =
                                cartProvider.chosenShippingList[i].id;
                            break;
                          }
                        }
                      }
