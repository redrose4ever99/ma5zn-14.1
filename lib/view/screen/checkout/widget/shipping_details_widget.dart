...
import 'package:com.makzan.eco/view/screen/address/saved_address_list_screen.dart';
import 'package:com.makzan.eco/view/screen/address/saved_billing_address_list_screen.dart';
...
class ShippingDetailsWidget extends StatelessWidget {
  ...
  const ShippingDetailsWidget(
      {Key? key, required this.hasPhysical, required this.billingAddress})
      : super(key: key);
