...
import 'package:com.makzan.eco/view/screen/checkout/widget/coupon_bottom_sheet.dart';
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Row(children: [
                  ...
                  Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                      child: Text('(-${couponProvider.discount} off)', style: textMedium.copyWith(color: Theme.of(context).primaryColor),),),
