                ...
                fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                  ...
                  return TextFormField(
                    ...
                    decoration: InputDecoration(
                     ...
                     suffixIcon: SizedBox(width: controller.text.isNotEmpty? 80 : 60,
                       child: Row(
                         children: [
                           ...
                           InkWell(onTap: (){
                             ...
                             child: Padding(padding: const EdgeInsets.all(5),
                               child: Container(width: 50, height: 50,decoration: BoxDecoration(color: Theme.of(context).primaryColor,
