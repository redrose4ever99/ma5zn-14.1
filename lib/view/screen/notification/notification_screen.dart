...
import 'package:com.makzan.eco/view/screen/notification/widget/notification_dialog.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  CustomAppBar(title: getTranslated('notification', context), isBackButtonExist: widget.isBacButtonExist),
