...
import 'package:com.makzan.eco/data/model/response/brand_model.dart';
...
class ProductFilterDialog extends StatefulWidget {
  ...
  const ProductFilterDialog({Key? key, this.sellerId, this.fromShop = true})
      : super(key: key);
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: CustomButton(
                              ...
                              onTap: () {
                                searchProvider.isLoadFilter = true;
